...
// upstream source for repeat queries — the search-suggestion dropdown and the
// full results page share the same entries. Keyed by source id so changing
// the configured source never serves stale cross-source hits.
const cache = new Map();
