    ...
    if (panel === "queue") {
        return (
            <>
                ...
                <div className="sticky top-0 z-10 flex items-center gap-2.5 bg-gradient-to-b from-surface via-surface via-[70%] to-transparent px-4 pb-10 pt-5 text-sm font-bold text-maintext">
